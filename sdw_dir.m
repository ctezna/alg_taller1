...
%
% A modified Stahel-Donoho projection directions generator
% Based on subsampling with nr replications
% Pairs of observations are sampled, and from the directions defined
% by them and the projections onto these directions weights are
% assigned for further sampling
%
%    V = sdw_dir(x,num_dir,labels)
%
%  Output:
%  V,       generated directions
%
%  Inputs:
%  num_dir, number of directions to generate
